    ...
    <div v-clickoutside="handleClose" class="fr user-dropdown">
      ...
      <transition name="el-zoom-in-top">
        <ul v-if="isMsgMenuShow" class="uirb-dropdown">
          ...
          <li v-access="'sysconf'" @click="openNewTab('/system')">系统配置</li>
...
import personalInfoDialog from '@/views/personalCenter/components/personalInfo'
import resetPwdDialog from '@/views/personalCenter/components/resetPassword'
...
export default {
  ...
  methods: {
     ...
     */
    editUserInfo () {
      this.$dialog(personalInfoDialog, { user: this.loginUserInfo })
    },
     ...
     */
    resetPassword () {
      this.$dialog(resetPwdDialog, { user: this.loginUserInfo })
    },
