...
export default {
  ...
  methods: {
    ...
    queryList() {
      this.loading = true
      let url = `/standards/${this.$route.query.standardid}/dissertations/${this.$route.query.topicid}/resources/data/count`
    ...
    moveTo(item, ifOneRes) {
      ...
      this.$router.push({ path: '/manage/topic/list', query: params})
    },
